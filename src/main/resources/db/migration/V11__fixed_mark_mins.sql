DROP TRIGGER add_to_total_stats_after_delete ON attendances;
DROP TRIGGER add_to_total_stats_after_insert ON attendances;
DROP TRIGGER add_to_total_stats_after_update ON attendances;
